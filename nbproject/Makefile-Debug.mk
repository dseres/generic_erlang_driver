...
${OBJECTDIR}/driver.o: driver.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../erl/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/driver.o driver.cpp

${OBJECTDIR}/ei_functions.o: ei_functions.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../erl/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ei_functions.o ei_functions.cpp
...
.build-tests-subprojects:
	cd ../erl/src/ei && ${MAKE}  -f Makefile CONF=Debug
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/DriverTest.o ${TESTDIR}/tests/GenErlDrvTestRunner.o ${TESTDIR}/tests/InvokerTest.o ${TESTDIR}/tests/MarshallerTest.o ${TESTDIR}/tests/NetbeansTestProgressListener.o ${TESTDIR}/tests/TestFunctionsAndDriver.o ${TESTDIR}/tests/helpers.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	${LINK.cc} -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS}   ../erl/src/ei/dist/Debug/MinGW-Windows/libei.a `cppunit-config --libs`   


${TESTDIR}/tests/DriverTest.o: tests/DriverTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../erl/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/DriverTest.o tests/DriverTest.cpp


${TESTDIR}/tests/GenErlDrvTestRunner.o: tests/GenErlDrvTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../erl/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/GenErlDrvTestRunner.o tests/GenErlDrvTestRunner.cpp


${TESTDIR}/tests/InvokerTest.o: tests/InvokerTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../erl/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/InvokerTest.o tests/InvokerTest.cpp


${TESTDIR}/tests/MarshallerTest.o: tests/MarshallerTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../erl/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MarshallerTest.o tests/MarshallerTest.cpp


${TESTDIR}/tests/NetbeansTestProgressListener.o: tests/NetbeansTestProgressListener.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../erl/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/NetbeansTestProgressListener.o tests/NetbeansTestProgressListener.cpp


${TESTDIR}/tests/TestFunctionsAndDriver.o: tests/TestFunctionsAndDriver.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../erl/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TestFunctionsAndDriver.o tests/TestFunctionsAndDriver.cpp


${TESTDIR}/tests/helpers.o: tests/helpers.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../erl/include `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/helpers.o tests/helpers.cpp
...
${OBJECTDIR}/driver_nomain.o: ${OBJECTDIR}/driver.o driver.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I../erl/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/driver_nomain.o driver.cpp;\
	else  \
...
${OBJECTDIR}/ei_functions_nomain.o: ${OBJECTDIR}/ei_functions.o ei_functions.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -I../erl/include -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ei_functions_nomain.o ei_functions.cpp;\
	else  \
